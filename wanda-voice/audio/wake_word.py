...
class SimpleWakeWordDetector:
    ...
    def _detection_loop(self):
        ...
        try:
            ...
            while self.running:
                # Record short chunk
                audio = sd.rec(chunk_samples, samplerate=16000, channels=1, dtype='float32')
                sd.wait()
...
def get_wake_word_detector(on_wake: Callable = None, stt_engine = None):
