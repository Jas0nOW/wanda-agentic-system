...
Diese Dokumentation ist die "Sovereign Source of Truth" (SSOT) fuer das agentische System von Jannis.
...
- **ultrabrain**: Claude 4.5 Opus (Thinking) [Max Budget] - Hoechste Logik.
- **deep**: Claude 4.5 Opus (Thinking) [Max Budget] - Autonome Problemloesung.
...
## MCP Tool-Ecosystem (Managed Stability)
...
- **Status**: VERCEL_TOKEN-Variable ist konfiguriert fuer Stabilitaet.
...
- **Context7**: Live-Dokumentation fuer SOTA Libraries.
