[Skip to content](https://github.com/code-yeongyu/oh-my-opencode/blob/dev/docs/configurations.md#start-of-content)

You signed in with another tab or window. [Reload](https://github.com/code-yeongyu/oh-my-opencode/blob/dev/docs/configurations.md) to refresh your session.You signed out in another tab or window. [Reload](https://github.com/code-yeongyu/oh-my-opencode/blob/dev/docs/configurations.md) to refresh your session.You switched accounts on another tab or window. [Reload](https://github.com/code-yeongyu/oh-my-opencode/blob/dev/docs/configurations.md) to refresh your session.Dismiss alert

{{ message }}

[code-yeongyu](https://github.com/code-yeongyu)/ **[oh-my-opencode](https://github.com/code-yeongyu/oh-my-opencode)** Public

- [Notifications](https://github.com/login?return_to=%2Fcode-yeongyu%2Foh-my-opencode) You must be signed in to change notification settings
- [Fork\\
1.9k](https://github.com/login?return_to=%2Fcode-yeongyu%2Foh-my-opencode)
- [Star\\
26.5k](https://github.com/login?return_to=%2Fcode-yeongyu%2Foh-my-opencode)
...
[History](https://github.com/code-yeongyu/oh-my-opencode/commits/dev/docs/configurations.md)

[View commit history for this file.](https://github.com/code-yeongyu/oh-my-opencode/commits/dev/docs/configurations.md) History

1243 lines (990 loc) · 49.8 KB
...
[Raw](https://github.com/code-yeongyu/oh-my-opencode/raw/refs/heads/dev/docs/configurations.md)
...
[Permalink: Oh-My-OpenCode Configuration](https://github.com/code-yeongyu/oh-my-opencode/blob/dev/docs/configurations.md#oh-my-opencode-configuration)

Highly opinionated, but adjustable to taste.

## Quick Start

[Permalink: Quick Start](https://github.com/code-yeongyu/oh-my-opencode/blob/dev/docs/configurations.md#quick-start)
...
[Permalink: Config File Locations](https://github.com/code-yeongyu/oh-my-opencode/blob/dev/docs/configurations.md#config-file-locations)
...
[Permalink: JSONC Support](https://github.com/code-yeongyu/oh-my-opencode/blob/dev/docs/configurations.md#jsonc-support)
...
[Permalink: Google Auth](https://github.com/code-yeongyu/oh-my-opencode/blob/dev/docs/configurations.md#google-auth)

**Recommended**: For Google Gemini authentication, install the [`opencode-antigravity-auth`](https://github.com/NoeFabris/opencode-antigravity-auth) plugin (`@latest`). It provides multi-account load balancing, variant-based thinking levels, dual quota system (Antigravity + Gemini CLI), and active maintenance. See [Installation > Google Gemini](https://github.com/code-yeongyu/oh-my-opencode/blob/dev/docs/docs/guide/installation.md#google-gemini-antigravity-oauth).

## Ollama Provider

[Permalink: Ollama Provider](https://github.com/code-yeongyu/oh-my-opencode/blob/dev/docs/configurations.md#ollama-provider)

**IMPORTANT**: When using Ollama as a provider, you **must** disable streaming to avoid JSON parsing errors.

### Required Configuration

[Permalink: Required Configuration](https://github.com/code-yeongyu/oh-my-opencode/blob/dev/docs/configurations.md#required-configuration)
...
[Permalink: Why stream: false is Required](https://github.com/code-yeongyu/oh-my-opencode/blob/dev/docs/configurations.md#why-stream-false-is-required)
...
[Permalink: Supported Models](https://github.com/code-yeongyu/oh-my-opencode/blob/dev/docs/configurations.md#supported-models)
...
[Permalink: Troubleshooting](https://github.com/code-yeongyu/oh-my-opencode/blob/dev/docs/configurations.md#troubleshooting)
...
4. **See detailed troubleshooting**: [docs/troubleshooting/ollama-streaming-issue.md](https://github.com/code-yeongyu/oh-my-opencode/blob/dev/docs/troubleshooting/ollama-streaming-issue.md)

### Future SDK Fix

[Permalink: Future SDK Fix](https://github.com/code-yeongyu/oh-my-opencode/blob/dev/docs/configurations.md#future-sdk-fix)
...
**Tracking**: [#1124](https://github.com/code-yeongyu/oh-my-opencode/issues/1124)

## Agents

[Permalink: Agents](https://github.com/code-yeongyu/oh-my-opencode/blob/dev/docs/configurations.md#agents)
...
[Permalink: Additional Agent Options](https://github.com/code-yeongyu/oh-my-opencode/blob/dev/docs/configurations.md#additional-agent-options)
...
| `thinking` | object | Extended thinking configuration for Anthropic models. See [Thinking Options](https://github.com/code-yeongyu/oh-my-opencode/blob/dev/docs/configurations.md#thinking-options) below. |
...
[Permalink: Thinking Options (Anthropic)](https://github.com/code-yeongyu/oh-my-opencode/blob/dev/docs/configurations.md#thinking-options-anthropic)
...
[Permalink: Permission Options](https://github.com/code-yeongyu/oh-my-opencode/blob/dev/docs/configurations.md#permission-options)
...
[Permalink: Built-in Skills](https://github.com/code-yeongyu/oh-my-opencode/blob/dev/docs/configurations.md#built-in-skills)

Oh My OpenCode includes built-in skills that provide additional capabilities:

- **playwright** (default) / **agent-browser**: Browser automation for web scraping, testing, screenshots, and browser interactions. See [Browser Automation](https://github.com/code-yeongyu/oh-my-opencode/blob/dev/docs/configurations.md#browser-automation) for switching between providers.
...
[Permalink: Skills Configuration](https://github.com/code-yeongyu/oh-my-opencode/blob/dev/docs/configurations.md#skills-configuration)
...
[Permalink: Sources](https://github.com/code-yeongyu/oh-my-opencode/blob/dev/docs/configurations.md#sources)
...
[Permalink: Enable/Disable Skills](https://github.com/code-yeongyu/oh-my-opencode/blob/dev/docs/configurations.md#enabledisable-skills)
...
[Permalink: Custom Skill Definition](https://github.com/code-yeongyu/oh-my-opencode/blob/dev/docs/configurations.md#custom-skill-definition)
...
[Permalink: Browser Automation](https://github.com/code-yeongyu/oh-my-opencode/blob/dev/docs/configurations.md#browser-automation)
...
[Permalink: Playwright (Default)](https://github.com/code-yeongyu/oh-my-opencode/blob/dev/docs/configurations.md#playwright-default)

Uses the official Playwright MCP server (`@playwright/mcp`). Browser automation happens through structured MCP tool calls.

### agent-browser

[Permalink: agent-browser](https://github.com/code-yeongyu/oh-my-opencode/blob/dev/docs/configurations.md#agent-browser)
...
[Permalink: Tmux Integration](https://github.com/code-yeongyu/oh-my-opencode/blob/dev/docs/configurations.md#tmux-integration)
...
| `layout` | `main-vertical` | Tmux layout for agent panes. See [Layout Options](https://github.com/code-yeongyu/oh-my-opencode/blob/dev/docs/configurations.md#layout-options) below. |
...
[Permalink: Layout Options](https://github.com/code-yeongyu/oh-my-opencode/blob/dev/docs/configurations.md#layout-options)
...
[Permalink: Requirements](https://github.com/code-yeongyu/oh-my-opencode/blob/dev/docs/configurations.md#requirements)
...
[Permalink: How It Works](https://github.com/code-yeongyu/oh-my-opencode/blob/dev/docs/configurations.md#how-it-works)
...
[Permalink: Running OpenCode with Tmux Subagent Support](https://github.com/code-yeongyu/oh-my-opencode/blob/dev/docs/configurations.md#running-opencode-with-tmux-subagent-support)
...
[Permalink: Server Mode Reference](https://github.com/code-yeongyu/oh-my-opencode/blob/dev/docs/configurations.md#server-mode-reference)
...
[Permalink: Git Master](https://github.com/code-yeongyu/oh-my-opencode/blob/dev/docs/configurations.md#git-master)
...
[Permalink: Sisyphus Agent](https://github.com/code-yeongyu/oh-my-opencode/blob/dev/docs/configurations.md#sisyphus-agent)
...
[Permalink: Background Tasks](https://github.com/code-yeongyu/oh-my-opencode/blob/dev/docs/configurations.md#background-tasks)
...
[Permalink: Categories](https://github.com/code-yeongyu/oh-my-opencode/blob/dev/docs/configurations.md#categories)

Categories enable domain-specific task delegation via the `delegate_task` tool. Each category applies runtime presets (model, temperature, prompt additions) when calling the `Sisyphus-Junior` agent.

### Built-in Categories

[Permalink: Built-in Categories](https://github.com/code-yeongyu/oh-my-opencode/blob/dev/docs/configurations.md#built-in-categories)
...
[Permalink: ⚠️ Critical: Model Resolution Priority](https://github.com/code-yeongyu/oh-my-opencode/blob/dev/docs/configurations.md#%EF%B8%8F-critical-model-resolution-priority)
...
[Permalink: Recommended Configuration](https://github.com/code-yeongyu/oh-my-opencode/blob/dev/docs/configurations.md#recommended-configuration)
...
[Permalink: Usage](https://github.com/code-yeongyu/oh-my-opencode/blob/dev/docs/configurations.md#usage)
...
[Permalink: Custom Categories](https://github.com/code-yeongyu/oh-my-opencode/blob/dev/docs/configurations.md#custom-categories)
...
[Permalink: Additional Category Options](https://github.com/code-yeongyu/oh-my-opencode/blob/dev/docs/configurations.md#additional-category-options)

| Option | Type | Default | Description |
| --- | --- | --- | --- |
| `description` | string | - | Human-readable description of the category's purpose. Shown in delegate\_task prompt. |
...
[Permalink: Model Resolution System](https://github.com/code-yeongyu/oh-my-opencode/blob/dev/docs/configurations.md#model-resolution-system)
...
[Permalink: Overview](https://github.com/code-yeongyu/oh-my-opencode/blob/dev/docs/configurations.md#overview)
...
[Permalink: Resolution Flow](https://github.com/code-yeongyu/oh-my-opencode/blob/dev/docs/configurations.md#resolution-flow)
...
[Permalink: Agent Provider Chains](https://github.com/code-yeongyu/oh-my-opencode/blob/dev/docs/configurations.md#agent-provider-chains)
...
[Permalink: Category Provider Chains](https://github.com/code-yeongyu/oh-my-opencode/blob/dev/docs/configurations.md#category-provider-chains)
...
[Permalink: Checking Your Configuration](https://github.com/code-yeongyu/oh-my-opencode/blob/dev/docs/configurations.md#checking-your-configuration)
...
[Permalink: Manual Override](https://github.com/code-yeongyu/oh-my-opencode/blob/dev/docs/configurations.md#manual-override)
...
[Permalink: Hooks](https://github.com/code-yeongyu/oh-my-opencode/blob/dev/docs/configurations.md#hooks)
...
[Permalink: Disabled Commands](https://github.com/code-yeongyu/oh-my-opencode/blob/dev/docs/configurations.md#disabled-commands)
...
[Permalink: Comment Checker](https://github.com/code-yeongyu/oh-my-opencode/blob/dev/docs/configurations.md#comment-checker)
...
[Permalink: Notification](https://github.com/code-yeongyu/oh-my-opencode/blob/dev/docs/configurations.md#notification)
...
[Permalink: Sisyphus Tasks & Swarm](https://github.com/code-yeongyu/oh-my-opencode/blob/dev/docs/configurations.md#sisyphus-tasks--swarm)
...
[Permalink: Tasks Configuration](https://github.com/code-yeongyu/oh-my-opencode/blob/dev/docs/configurations.md#tasks-configuration)
...
[Permalink: Swarm Configuration](https://github.com/code-yeongyu/oh-my-opencode/blob/dev/docs/configurations.md#swarm-configuration)
...
[Permalink: MCPs](https://github.com/code-yeongyu/oh-my-opencode/blob/dev/docs/configurations.md#mcps)
...
- **grep\_app**: Ultra-fast code search across millions of public GitHub repositories via [grep.app](https://grep.app/)
...
[Permalink: LSP](https://github.com/code-yeongyu/oh-my-opencode/blob/dev/docs/configurations.md#lsp)
...
[Permalink: Experimental](https://github.com/code-yeongyu/oh-my-opencode/blob/dev/docs/configurations.md#experimental)
...
| `dynamic_context_pruning` | See below | Dynamic context pruning configuration for managing context window usage automatically. See [Dynamic Context Pruning](https://github.com/code-yeongyu/oh-my-opencode/blob/dev/docs/configurations.md#dynamic-context-pruning) below. |

### Dynamic Context Pruning

[Permalink: Dynamic Context Pruning](https://github.com/code-yeongyu/oh-my-opencode/blob/dev/docs/configurations.md#dynamic-context-pruning)
...
[Permalink: Turn Protection](https://github.com/code-yeongyu/oh-my-opencode/blob/dev/docs/configurations.md#turn-protection)
...
[Permalink: Protected Tools](https://github.com/code-yeongyu/oh-my-opencode/blob/dev/docs/configurations.md#protected-tools)
...
[Permalink: Pruning Strategies](https://github.com/code-yeongyu/oh-my-opencode/blob/dev/docs/configurations.md#pruning-strategies)

| Strategy | Option | Default | Description |
| --- | --- | --- | --- |
| **deduplication** | `enabled` | `true` | Remove duplicate tool calls (same tool + same args) |
| **supersede\_writes** | `enabled` | `true` | Prune write inputs when file subsequently read |
|  | `aggressive` | `false` | Aggressive mode: prune any write if ANY subsequent read |
| **purge\_errors** | `enabled` | `true` | Prune errored tool inputs after N turns |
...
[Permalink: Environment Variables](https://github.com/code-yeongyu/oh-my-opencode/blob/dev/docs/configurations.md#environment-variables)
