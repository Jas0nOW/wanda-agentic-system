...
class StateMachine:
    ...
    PAUSE_COMMANDS = [
        "pause", "wanda stopp", "wanda pause", "pausiere dich",
        "stopp", "schlaf", "wanda schlaf"
    ]
    
    RESUME_COMMANDS = [
        "wanda weiter", "fortfahren", "aufwachen", "hallo wanda",
        "wanda fortfahren", "weiter", "wach auf"
    ]
    
    AUTONOMOUS_TRIGGERS = [
        "vollautonom", "vollautomatisch", "wanda mode", "los wanda",
        "autonom", "übernimm", "mach alles"
    ]
